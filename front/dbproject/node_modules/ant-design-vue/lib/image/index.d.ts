...
declare const _default: {
    new (...args: any[]): {
        ...
        $props: {
            ...
            readonly referrerpolicy?: "" | "origin" | "no-referrer" | "no-referrer-when-downgrade" | "origin-when-cross-origin" | "same-origin" | "strict-origin" | "strict-origin-when-cross-origin" | "unsafe-url";
        };
        $attrs: {
            [x: string]: unknown;
        };
